  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="../../../view/v-cliente/" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column" style="display: block;">
          <li class="nav-item">
            <a href="./index.php" class="nav-link">Ventas por producto</a>
          </li>
          <li class="nav-item">
            <a href="../p-cliente/index.php" class="nav-link">Ventas por cliente</a>
          </li>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item">Reportes</a>
          <span class="breadcrumb-item active">Producto</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Reporte de Productos</h4>
