    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fa fa-fax tx-22"></i>
        ...
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-calculator tx-24"></i>
        ...
        <ul class="br-menu-sub nav flex-column" style="display: block;">
          <li class="nav-item">
            <a href="accordion.html" class="nav-link">Ventas por producto</a>
          </li>
          <li class="nav-item">
            <a href="alerts.html" class="nav-link">Ventas por cliente</a>
          </li>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="../../index.php">Bienvenido</a>
          <span class="breadcrumb-item active">Inicio</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Inicio</h4>
        <p class="mg-b-0">Bienvenido, en este pequeño proyecto tratamos de hacer un CRUD \n con PHP,JS,JQUERY, utilizando JS - datatables y la plantilla de Brackets Basada en BOOTSTRAP 4.
